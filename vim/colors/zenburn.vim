...
if &t_Co > 255
    ...
    hi Conditional     ctermfg=144   cterm=bold
    ...
    hi Keyword         ctermfg=228   cterm=bold
    ...
    hi PreCondit       ctermfg=173   cterm=bold
    hi PreProc         ctermfg=67    cterm=bold
    hi Question        ctermfg=15    cterm=bold
    hi Repeat          ctermfg=144   cterm=bold

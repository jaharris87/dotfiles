...
au BufNewFile,BufRead ?\+.omp,?\+.orig,?\+.bak,?\+.old,?\+.new,?\+.dpkg-dist,?\+.dpkg-old,?\+.rpmsave,?\+.rpmnew
...
" CSV
"au BufNewFile,BufRead *.csv,*.dat,*.asc,*.tab   setf csv
...
" Makefile
au BufNewFile,BufRead *[mM]akefile*,*.mk,*.mak,*.dsp,[mM]ake.*,[mM]akefile.* setf make
...
" Python
au BufNewFile,BufRead *.[pP][yY]		setf python
...
au BufNewFile,BufRead .bashrc*,bashrc,bash.bashrc,.bash_profile*,.bash_logout*,*.bash,*.ebuild,*.bash_completion call SetFileTypeSH("bash")

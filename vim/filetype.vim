...
au BufNewFile,BufRead ?\+.omp,?\+.orig,?\+.bak,?\+.old,?\+.new,?\+.dpkg-dist,?\+.dpkg-old,?\+.dpkg-new,?\+.dpkg-bak,?\+.rpmsave,?\+.rpmnew,?\+.pacsave,?\+.pacnew
...
au BufNewFile,BufRead inputs*                   setf conf
...
au BufNewFile,BufRead *.MARKDOWN,*.MDOWN,*.MKD,*.MKDN,*.MDWN,*.MD  setf markdown
au BufNewFile,BufRead [Rr][Ee][Aa][Dd][Mm][Ee]*	setf markdown
...
au BufNewFile,BufRead *.[pP][yY],*.pyw,.pythonstartup,.pythonrc  setf python
...
" Fortran
if has("fname_case")
  au BufNewFile,BufRead *.F.*,*.FOR.*,*.FPP.*,*.FTN.*,*.F77.*,*.F90.*,*.F95.*,*.F03.*,*.F08	 call s:StarSetf('fortran')
endif
au BufNewFile,BufRead   *.f.*,*.for.*,*.fortran.*,*.fpp.*,*.ftn.*,*.f77.*,*.f90.*,*.f95.*,*.f03.*,*.f08  call s:StarSetf('fortran')
...
" Makefile
au BufNewFile,BufRead [mM]ake*			call s:StarSetf('make')
